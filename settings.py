...
GRAVITY = 1
JUMP_HEIGHT = 15
# Thời gian thực hiện chức năng tăng tốc
BLINK_TIME = 1

BLINK_DISTANCE = 75
# Tăng tốc (di chuyên đến vị trí x+5)
BLINK_SPEED = 100
# Thời gian phục hồi chức năng tăng tốc
BLINK_RETRACT = 500
# Tốc độ chuyển ảnh
...
LEVEL_1_BG = 'background.png'

LEVEL_1_PUPS = [(1908, 3)]

LEVEL_1_BOSSES = [(6616, 83), (6658, 171), (6616, 258), (6658, 352)]

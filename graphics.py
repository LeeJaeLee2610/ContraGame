...
l1_bg = pygame.image.load(os.path.join(imgFolder, 'background.png')).convert()
...
PLAYER_RIGHT_DOWN_0 = player_sheet.get_image(144, 55, 19, 35).convert()
PLAYER_RIGHT_DOWN_1 = player_sheet.get_image(170, 56, 19, 33).convert()
PLAYER_RIGHT_DOWN_2 = player_sheet.get_image(195, 56, 23, 34).convert()
...
PLAYER_DEAD_3 = player_sheet.get_image(170, 193, 19, 23).convert()
PLAYER_DEAD_2 = player_sheet.get_image(192, 198, 22, 18).convert()
PLAYER_DEAD_1 = player_sheet.get_image(219, 194, 17, 22).convert()
PLAYER_DEAD_4 = player_sheet.get_image(238, 204, 35, 11).convert()
PLAYER_PRONE = player_sheet.get_image(145, 176, 35, 11).convert()
...
DROP = pygame.image.load(os.path.join(imgFolder, 'drop.png')).convert()
FLASH = pygame.image.load(os.path.join(imgFolder, 'force.png')).convert()
HEATH = pygame.image.load(os.path.join(imgFolder, 'heath.png')).convert()
